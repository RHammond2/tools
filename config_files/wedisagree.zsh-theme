...
ZSH_THEME_GIT_PROMPT_DIRTY="%{$fg[yellow]%} ζ,,ﾟДﾟζ" # ☂ Ⓓ
ZSH_THEME_GIT_PROMPT_UNTRACKED="%{$fg[cyan]%} ಥ_ಥ" # ✭ ⓣ
ZSH_THEME_GIT_PROMPT_CLEAN="%{$fg[green]%} /[^._.^]ﾉ彡" # ☀ Ⓞ

ZSH_THEME_GIT_PROMPT_ADDED="%{$fg[cyan]%} ✚ " # ⓐ ⑃
ZSH_THEME_GIT_PROMPT_MODIFIED="%{$fg[yellow]%} (╯°□°）╯︵ ┻━┻ "  # ⚡ ⓜ ⑁
ZSH_THEME_GIT_PROMPT_DELETED="%{$fg[red]%} ¯\_(ツ)_/¯ " # ✖ ⓧ ⑂
ZSH_THEME_GIT_PROMPT_RENAMED="%{$fg[blue]%} ➜ " # ⓡ ⑄
ZSH_THEME_GIT_PROMPT_UNMERGED="%{$fg[magenta]%} ヽ༼ ಠ益ಠ ༽ﾉ " # ♒ ⓤ ⑊
